...
public class calculate_density {
...
//	private HashMap<Integer,Double> finalResult;
	...
	public calculate_density(String path) {
		numVertices = 0;
		numEdges = 0;
...
//		finalResult = new HashMap<Integer,Double>();
	...
	public void density() {
		double result = 2.0 * numEdges / (numVertices * (numVertices-1));
		System.out.println("density: " + result);
	}
	
	public static void main(String args[]) {
		calculate_density cd = new calculate_density(args[0]);
		cd.readData();
//		cd.testData();
		cd.density();
	} 
